...
ALTER TABLE config_info ADD COLUMN encrypted_data_key LONG VARCHAR DEFAULT NULL;

ALTER TABLE his_config_info ADD COLUMN encrypted_data_key LONG VARCHAR DEFAULT NULL;

ALTER TABLE config_info_beta ADD COLUMN encrypted_data_key LONG VARCHAR DEFAULT NULL;
